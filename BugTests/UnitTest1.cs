...
using BugPro; // Убедитесь, что пространство имен соответствует вашему проекту
using Stateless;
...
public class BugTests
{
    ...
    {
        var bug = new Bug(Bug.State.Open);
        bug.Resolve(); // Должно выбросить исключение
    }
    ...
    {
        var bug = new Bug(Bug.State.Defered);
        bug.Close(); // Должно выбросить исключение
    }
    ...
    {
        var bug = new Bug(Bug.State.InProgress);
        bug.Assign(); // Должно выбросить исключение
    }
    ...
    {
        var bug = new Bug(Bug.State.Resolved);
        bug.Defer(); // Должно выбросить исключение
    }
    ...
    {
        var bug = new Bug(Bug.State.Open);
        bug.Start(); // Должно выбросить исключение
    }
